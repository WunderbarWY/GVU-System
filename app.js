...
const DRIFT_PROFILES = {
  raider:     { ampBase: 0.55, ampVar: 0.22, freqBase: 0.02, freqVar: 0.01 },  // 袭扰艇 — 轻快飘忽
  frigate:    { ampBase: 0.42, ampVar: 0.18, freqBase: 0.016, freqVar: 0.008 },  // 护卫舰
  destroyer:  { ampBase: 0.32, ampVar: 0.14, freqBase: 0.012, freqVar: 0.007 },  // 驱逐舰
  cruiser:    { ampBase: 0.24, ampVar: 0.10, freqBase: 0.01, freqVar: 0.006 },  // 巡洋舰
  battleship: { ampBase: 0.18, ampVar: 0.08, freqBase: 0.008, freqVar: 0.005 },  // 战列舰
  dreadnought:{ ampBase: 0.12, ampVar: 0.06, freqBase: 0.006, freqVar: 0.003 },  // 旗舰/无畏舰 — 稳重
};
